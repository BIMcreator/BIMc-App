...
class ApiConnection implements Callable<String> {
  ...
  private ApiConnection(String url, RequestBody body) throws MalformedURLException {
    this.url = new URL(url);
    this.body = body;
  }
  ...
  static ApiConnection createPOST(String url, RequestBody body) throws MalformedURLException {
