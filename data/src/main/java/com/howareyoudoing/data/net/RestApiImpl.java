...
import com.howareyoudoing.data.entity.mapper.UserEntityJsonMapper;
import com.howareyoudoing.data.exception.NetworkConnectionException;
...
public class RestApiImpl implements RestApi {
  ...
  @Override
  public Observable<List<SingleUser>> userEntityList() {
  ...
  @Override
  public Observable<SingleUser> userEntityById(final int userId) {
    return Observable.create(emitter -> {
      if (isThereInternetConnection()) {
        try {
