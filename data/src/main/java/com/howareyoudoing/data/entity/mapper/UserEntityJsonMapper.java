 ...
 */
package com.howareyoudoing.data.entity.mapper;

import com.howareyoudoing.data.entity.SingleUser;
import com.howareyoudoing.data.entity.UserEntity;
...
public class UserEntityJsonMapper {
   ...
   * @throws com.google.gson.JsonSyntaxException if the json string is not a valid json structure.
   */
  public List<SingleUser> transformUserEntityCollection(String userListJsonResponse)
      throws JsonSyntaxException {
    final Type listOfType = new TypeToken<UserEntity>() {}.getType();
    UserEntity userEntity = this.gson.fromJson(userListJsonResponse, listOfType);
//    final Type listOfUserEntityType = new TypeToken<List<UserEntity>>() {}.getType();
//    UserResponse userResponse = this.gson.fromJson(userListJsonResponse, listOfUserEntityType);
//    return this.gson.fromJson(userListJsonResponse, listOfUserEntityType);
    ArrayList<SingleUser> singleUserList = new ArrayList<>(Arrays.asList(userEntity.getUserResponse().getSingleUser()));
