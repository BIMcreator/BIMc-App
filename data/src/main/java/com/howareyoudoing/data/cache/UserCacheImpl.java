...
import com.howareyoudoing.data.cache.serializer.Serializer;
import com.howareyoudoing.data.entity.SingleUser;
import com.howareyoudoing.data.exception.UserNotFoundException;
...
public class UserCacheImpl implements UserCache {
  ...
  private static final String SETTINGS_FILE_NAME = "com.howareyoudoing.bimc.SETTINGS";
  ...
  @Override
  public Observable<SingleUser> get(final int userId) {
    return Observable.create(emitter -> {
      ...
      final SingleUser userEntity =
          UserCacheImpl.this.serializer.deserialize(fileContent, SingleUser.class);
  ...
  @Override
  public void put(SingleUser userEntity) {
    if (userEntity != null) {
